...
use App\Filament\Resources\UserReferralResource\RelationManagers;
...
class UserReferralResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateUserReferral::route('/create'),
            'edit' => Pages\EditUserReferral::route('/{record}/edit'),
        ];
    }
}
